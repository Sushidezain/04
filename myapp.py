...
def calculate_EP(IP1, PM1, EP0):
    IP0 = st.number_input('IP0', value=0.0, format="%.0f", step=1000.0)
    PM0 = st.number_input('PM0', value=0.0, format="%.0f", step=1000.0)
...
def main():
    ...
    EP0 = st.number_input('EP0', value=0.0, format="%.0f", step=1000.0, value=1000000)
