...
def main():
    ...
    st.markdown('<br>' * 15 + '<p style="font-size: 12px; color: grey;">Made by: <a href="https://sushidezain.000webhostapp.com/" target="_blank">https://sushidezain.000webhostapp.com/</a></p>', unsafe_allow_html=True)
